...
(function ($) {
    ...
    var EditableTable = {
        ...
        rowEdit: function ($row) {
            ...
            $row.find('td:nth-child(1)').html('<input type="text" class="form-control input-block" value="' + data[0] + '"/>');
            ...
            $row.find('td:nth-child(4)').html('<input type="text" class="form-control input-block" value="' + data[3] + '"/>');
